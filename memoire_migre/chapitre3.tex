...
\EmplacementFigure{13cm}{7cm}{Diagramme de séquence — Consulter sa facturation}{fig:seq-billing}
...
\EmplacementFigure{14cm}{8cm}{Diagramme de séquence — Payer une facture}{fig:seq-pay}
...
Ce sprint livre la facturation à l'usage et son règlement en ligne, consultables par le client comme par l'équipe d'exploitation. Aucune limite de ressources par défaut n'est appliquée par tenant, ce qui expose le modèle à une facturation potentiellement illimitée en l'absence d'action du client ; ce point reste une limite assumée du projet.
...
\begin{figure}[H]
 \centering
    \includegraphics[width=0.9\textwidth]{image/Interface de gestion des comptes clients .png}
    \caption{Interface de gestion des comptes clients}
    \label{fig:capture-adminclients}
\end{figure}
...
\begin{figure}[H]
 \centering
    ...
    \caption{Interface de gestion des quotas}
...
\begin{figure}[H]
 \centering
    \includegraphics[width=0.9\textwidth]{image/capture_cluster.png}
...
\begin{figure}[H]
 \centering
    \includegraphics[width=0.9\textwidth]{image/capture_alerts.png}
