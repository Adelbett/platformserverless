...
\multirow{5}{*}{M1} & \multirow{5}{2.9cm}{\centering Authentification \& Sécurité} & M1.1 & En tant qu'ADMIN, CLIENT\_ADMIN ou MEMBER, je souhaite me connecter à la plateforme via Keycloak. & Moyenne\\
\cline{3-5}
...
\cline{3-5}
&& M1.5 & En tant qu'ADMIN, CLIENT\_ADMIN ou MEMBER, je souhaite générer une clé d'API pour piloter mes déploiements depuis un pipeline CI/CD externe. & Moyenne\\
\hline
...
\multirow{7}{*}{M4} & \multirow{7}{2.9cm}{\centering Gestion des applications} & M4.1 & En tant que CLIENT\_ADMIN ou MEMBER, je souhaite déployer une application à partir d'une image Docker. & Élevée\\
\cline{3-5}
