...
public class TeamService {
    ...
    private static final Set<String> MEMBER_ROLES =
            Set.of("DEVELOPER", "VIEWER", "BILLING_MANAGER");
    ...
    public UserDto addMember(String ownerId, AddMemberRequest req) {
        validateMemberRole(req.getRole());
    ...
    private void validateMemberRole(String role) {
        if (role == null || !MEMBER_ROLES.contains(role.toUpperCase()))
            throw new IllegalArgumentException(
                    "Invalid role: " + role + ". Allowed: DEVELOPER, VIEWER, BILLING_MANAGER");
    }
